    ...
    <xsl:template match="/">
        ...
        <html>
            ...
            <body>
                ...
                <footer>
                    <xsl:value-of select="rss/channel/title"/><span> er © </span><xsl:value-of
                        select="rss/channel/copyright"/><br/>
                    <span>Ikonene, <a href="http://glyphicons.com">GLYPHICONS</a>, er lisensiert under <a href="https://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a> og
                    har blitt endret fra originalene.</span>
                </footer>
            </body>
        </html>
    </xsl:template>
